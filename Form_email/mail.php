...
if($_POST)
{
	...
	else
	{
		...
		$mensaje="
Tenés un nuevo mensaje desde el Sitio de Avasa:
...
Comentarios: $comentarios";
		mail("gventas@avasagroup.com", "Comentario desde la Web de Avasa", $mensaje, "From: Sitio Web <mgacia@avasagruop.com>");
...
Correo electrónico: $correo
Comentarios: $comentarios";
		mail("marlongarcia2008@gmail.com", "Comentario desde la Web de Avasa", $mensaje, "From: Sitio Web <mgacia@avasagruop.com>");
		echo "OK";
	}
}
?>