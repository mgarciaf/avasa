...
(function( $, window, document, undefined ) {
	var Slider = {
		...
		addArrows: function(){
			...
			//	$(self.sliderId).before('<div class="coda-nav-left-arrow" data-dir="prev" title="Slide Izquierno"><a href="#"></a></div>');
			//	$(self.sliderId).after('<div class="coda-nav-right-arrow" data-dir="next" title="Slide Derecho"><a href="#"></a></div>');
			//}
			//else{
	...
	$.fn.codaSlider.options = {
		...
		//dynamicArrowLeftText: "&#171; Izquierda",
